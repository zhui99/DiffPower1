# Reference script for stiff Neural ODE training patterns.
# It is kept as a standalone experiment and serves as a training-style reference
# for the project-specific pipeline in TrainPipeline.jl.
